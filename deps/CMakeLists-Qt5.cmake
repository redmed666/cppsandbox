...
find_path(QT_IN_DEPS NAMES lib/libQt5Core.a PATHS ${QT}/)
if(QT_IN_DEPS)
    ...
    ExternalProject_Add(
        ...
        BUILD_IN_SOURCE 1
        UPDATE_COMMAND ""
        CONFIGURE_COMMAND ./configure -prefix ${QT} -opensource;-confirm-license;-release;-static;-optimized-qmake;-no-compile-examples;-qt-zlib;-qt-libpng;-qt-libjpeg;-qt-freetype;-qt-pcre;-qt-xcb;-qt-xkbcommon;-no-directfb;-no-linuxfb
        BUILD_COMMAND make
